...
function RecordDetails({navigation}) {
    ...
    const data = [
      ...
      ['Place of Violation', 'Zone 6, Cugman, Cagayan de Oro City, Misamis Oriental'],
        ...
        <View style={{height: 900}}>
          ...
          {modal ? (
            <View style={{width: "100%", height:"100%", position:"absolute", zIndex: 1, alignItems:"center", justifyContent:"center"}}>
                ...
                <TouchableOpacity style={{height: "100%", width:"100%"}} onPress={() => setModal(!modal)}>
                    <View  style={{backgroundColor:"black", opacity: 0.3, width: "100%", height:"100%", position:"absolute"}}></View>
                </TouchableOpacity>

            
                    <View style={{backgroundColor:"white", height:"80%", width:"90%", position:"absolute", borderRadius: 20, padding: 10}}>
                ...
                <KeyboardWithoutWrapper >
                    ...
                    <View style={{flexDirection:"column", flex: 1}}>
                        ...
                        <View style={{borderBottomWidth: 1, borderBottomColor: "#BBBBBB", marginTop: 20}}>
                            <View style={{marginTop: 15}}>
                                <Text style={{fontSize: 30, textAlign:"center", fontWeight:"bold", height: 60, paddingTop: 5}}>20230803</Text>
                            </View>
                            <View style={{flexDirection:"row", marginTop: 10, width: 400, paddingRight: 66}}>
                            ...
                            <View style={{flexDirection:"row", marginTop: 10, width: 200}}>
                                <Text style={{marginRight: 10, fontWeight: "bold"}}>Place of Violation:</Text>
                                <Text style={{fontWeight: "bold"}}>Zone 6, Cugman, Cagayan de Oro City, Misamis Oriental </Text>
                            </View>
                            ...
                            <View style={{flexDirection:"row", marginTop: 10, paddingRight: 66, width: 250}}>
